...
const std::vector<Model> SceneToLoad = {
	{"floor.obj", "MapSciFi1024.png", {0, 0, 0}, 10, Flat},
	{"rock1.obj", "Colors.png", {0, 0, 0}, 0.035, Flat},
	{"Boat.obj", "boat_diffuse.bmp", {0, 0, 0}, 0.001, Flat}};
...
private:
	...
	{
		auto app = reinterpret_cast<Project *>(glfwGetWindowUserPointer(window));
	...
	glm::mat4 projection()
	{
		...
		glm::mat4 rotX = glm::rotate(glm::mat4(1), glm::radians(-20.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glm::mat4 translate = glm::translate(glm::mat4(1), glm::vec3(0.0f, -0.6f, 0.0f));

		return rotZ * rotX * translate;
	}
	...
	void updateUniformBuffer(uint32_t currentImage)
	{
		...
		*/
		Prj = glm::mat4(1);
		glm::mat4 rotX = glm::rotate(glm::mat4(1), glm::radians(10.0f), glm::vec3(1, 0, 0));
		glm::mat4 rotZ = glm::rotate(glm::mat4(1), glm::radians(180.0f), glm::vec3(0, 0, 1));
		Prj = Prj * rotX * rotZ;
