...
protected:
    ...
    void localInit()
    {
        ...
        DSL_SB.init(this, {{0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, VK_SHADER_STAGE_VERTEX_BIT},
                           {1, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT}});
        P_SB.init(this, "shaders/SkyBoxVert.spv", "shaders/SkyBoxFrag.spv", {&DSL_SB}, VK_COMPARE_OP_LESS_OR_EQUAL);
        DS_SB.init(this, &DSL_SB, {{0, UNIFORM, sizeof(SkyBoxUniformBufferObject), nullptr}, {1, TEXTURE, 0, &(SkyBox.TD)}});
        ...
        DS_Table.init(this, &DSL1, {// the second parameter, is a pointer to the Uniform Set Layout of this set
        ...
        DS_BluePaddle.init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_BluePaddle}});
        M_RedPaddle.init(this, MODEL_DIR + "/Paddle.obj");
        T_RedPaddle.init(this, TEXTURE_DIR + "/red.jpeg");
        DS_RedPaddle.init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_RedPaddle}});

        M_Disk.init(this, MODEL_DIR + "/Disk.obj");
        T_Disk.init(this, TEXTURE_DIR + "/yellow.jpeg");
        DS_Disk.init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_Disk}});
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            DS_PL1_V1[i].init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_PL1_V1[i]}});
            M_PL2_V1[i].init(this, MODEL_DIR + "/" + map[i] + ".obj");
            T_PL2_V1[i].init(this, TEXTURE_DIR + "/scoreRed.png");
            DS_PL2_V1[i].init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_PL2_V1[i]}});
            M_PL1_V2[i].init(this, MODEL_DIR + "/" + map[i] + ".obj");
            T_PL1_V2[i].init(this, TEXTURE_DIR + "/scoreBlue.png");
            DS_PL1_V2[i].init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_PL1_V2[i]}});
            M_PL2_V2[i].init(this, MODEL_DIR + "/" + map[i] + ".obj");
            T_PL2_V2[i].init(this, TEXTURE_DIR + "/scoreRed.png");
            DS_PL2_V2[i].init(this, &DSL1, {{0, UNIFORM, sizeof(UniformBufferObject), nullptr}, {1, TEXTURE, 0, &T_PL2_V2[i]}});
        }
    }
