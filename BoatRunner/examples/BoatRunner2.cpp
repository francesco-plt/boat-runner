...
class BoatRunner : public BaseProject {
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        modelUniformBufferObject mubo{};
        void *data;

        gubo.view = LookAtMat(camPos, camPos + camDir);
        ...
        // 2. Boat
        mubo.model = I;
        glm::translate(mubo.model, boatPos);
        mubo.model = glm::scale(mubo.model, boatScalingFactor);

        vkMapMemory(device, DS_Boat.uniformBuffersMemory[0][currentImage], 0, sizeof(mubo), 0, &data);
